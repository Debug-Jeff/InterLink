...
import { LayoutDashboard, Users, FileText, Settings, LogOut } from "lucide-react" // Import LogOut icon
...
// Sample navigation items for Admin
const navItems = [
  {
    group: "Main",
    items: [
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="h-8 w-8 mr-2 group-data-[collapsible=icon]:mr-0">
                <AvatarImage src="/placeholder.svg?height=32&width=32" alt="Admin Avatar" />
                <AvatarFallback>
                  {adminName.charAt(0).toUpperCase()}
                  {adminName.split(" ")[1]?.charAt(0).toUpperCase() || ""}
                </AvatarFallback>
              </Avatar>
              <span className="font-medium text-gray-800 group-data-[collapsible=icon]:hidden">{adminName}</span>
            </Button>
          </DropdownMenuTrigger>
