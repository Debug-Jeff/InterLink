...
export default function CompanyAppearancePage() {
  return (
    <div className="space-y-8">
      <h1 className="text-4xl font-bold text-gray-800">Company Appearance Settings</h1>
      <p className="text-lg text-gray-600">Customize the visual theme of your company portal.</p>
