...
export function CompanyNavbar() {
  return (
    <nav className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-gray-100 bg-white/80 backdrop-blur-sm px-4 md:px-8">
      {/* Mobile Sidebar Trigger & Company Logo */}
      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem>New client inquiry!</DropdownMenuItem>
            <DropdownMenuItem>Project Alpha deadline approaching.</DropdownMenuItem>
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="relative h-9 w-9 rounded-full">
              <Avatar className="h-9 w-9">
                <AvatarImage src="/placeholder.svg?height=36&width=36" alt="Company User Avatar" />
                <AvatarFallback>AC</AvatarFallback>
              </Avatar>
              <span className="sr-only">Company menu</span>
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="w-48">
            <DropdownMenuLabel>Acme Corp.</DropdownMenuLabel>
            <DropdownMenuSeparator />
